...
func TestNewCmd(t *testing.T) {
	client := fake.NewSimpleClientset(mock.ReplicaSet("test", "test", nil, nil, nil))
...
func TestRun(t *testing.T) {
	...
	var b bytes.Buffer
	client := fake.NewSimpleClientset(mock.ReplicaSet("test", "test", map[string]string{"k": "v", "k2": "v2"}, nil, nil))
	validate(t, &testCase{
