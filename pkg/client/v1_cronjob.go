...
func (client *Client) CronJobV1(resource string) *Client {
	resp, err := client.BatchV1().CronJobs(client.namespace).Get(context.TODO(), resource, metav1.GetOptions{})
	if err != nil {
...
func (client *Client) CronJobsV1() ([]string, error) {
	res := []string{}

	resp, err := client.BatchV1().CronJobs(client.namespace).List(context.TODO(), metav1.ListOptions{})
	if err != nil {
