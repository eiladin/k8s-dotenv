...
func TestClientReplicaSetV1(t *testing.T) {
	...
	validate := func(t *testing.T, tc *testCase) {
		t.Run(tc.Name, func(t *testing.T) {
			actualClient := tc.Client.ReplicaSetV1(tc.Resource)
...
func TestClientReplicaSetsV1(t *testing.T) {
	type testCase struct {
		Name          string
		Client        *Client
	...
	validate := func(t *testing.T, tc *testCase) {
		t.Run(tc.Name, func(t *testing.T) {
			actualSlice, actualError := tc.Client.ReplicaSetsV1()
